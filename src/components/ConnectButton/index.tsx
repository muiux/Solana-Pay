...
const ConnectButton = observer((props: Props) => {
  const { walletList, handleSetSelectedWallet, onWalletDisconnect } = props;
  ...
  useEffect(() => {
    if (!connectedWallet) {
      ...
      userStore.setUserWalletAddress(connectedWallet.terraAddress);
    }
